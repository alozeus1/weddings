...
export const metadata: Metadata = {
  title: "Vacation Library"
};

export const dynamic = "force-dynamic";

export default function VacationLibraryPage(): React.JSX.Element {
  const vacationImages = getRandomizedVacationGalleryImages();
  const heroImage = heroImages.vacationLibrary ?? vacationImages[0] ?? heroImages.gallery;
  const featuredImage = vacationImages[1] ?? vacationImages[0] ?? heroImage;
